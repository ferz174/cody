...
ScanDrawing.sqlGetScanDrawings = "select item File, name FileName, parent Project, date_format(scandate,'%d.%m.%Y %H:%i:%s') Date from "+db_scan_table+" where scandate > ? and scandate < adddate(?, interval 1 day)";
