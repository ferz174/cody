...
ScanDrawing.sqlGetScanDrawings = "select item File, name FileName, date_format(scandate,'%d.%m.%Y %H:%i:%s') date from "+db_scan_table+" where scandate > ? and scandate < adddate(?, interval 1 day)";
