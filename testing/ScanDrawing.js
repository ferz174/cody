...
ScanDrawing.sqlGetScanDrawings = "select item File, name FileName, parent Project, date_format(scandate,'%d.%m.%Y') Date, date_format(scandate,'%H:%i:%s') Time from "+db_scan_table+" where scandate > ? and scandate < adddate(?, interval 1 day)";
