...
ScanDrawing.sqlGetScanDrawings = "select date_format(scandate,'%d.%m.%Y') Date, date_format(scandate,'%H:%i:%s') Time, parent Project, name FileName, item File from "+db_scan_table+" where scandate > ? and scandate < adddate(?, interval 1 day)";
